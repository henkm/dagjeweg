  ...
  describe "invalid credentials" do
    ...
    it "raises error when credentials are wrong" do
      ...
      # VCR.use_cassette("request-tips-without-credentials") do
        expect { Dagjeweg::Tip.find(21) }.to raise_error(DagjewegError, "Ongeldige API Key (403)")
      # end
    end
  ...
  describe "valid credentials" do
	  ...
	  describe "#search" do
	    ...
	    it "returns relevant tips for query" do
		    	...
		    	expect(tips.map(&:id)).to include(22) #DagjeWeg ID van dolfinarium
	    end
	  ...
	  describe "#nearby"  do
	    ...
	    it "returns a list of nearby tips" do
	      # VCR.use_cassette("request-nearby-tips") do
	    		...
	    		expect(nearby_tips.count).to be > 10
